...
## Corpus Check
- 87 files · ~32,725 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 518 nodes · 927 edges · 31 communities (28 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88daddc6`
...
Cohesion: 0.04
Nodes (44): dependencies, class-variance-authority, clsx, drizzle-orm, @fontsource-variable/geist, framer-motion, hono, lucide-react (+36 more)
...
Cohesion: 0.11
Nodes (17): getJournalSha256(), TransactionId, TransactionIdSchema, TransactionLineIdSchema, Transaction, TransactionPosting, TransactionPostingSchema, TransactionSchema (+9 more)

### Community 6 - "Connector Management"
Cohesion: 0.08
Nodes (7): ConnectorsController, updateConnectorSchema, ConnectorRecord, ConnectorsRepository, connectorsRouter, ConnectorsService, InboxController
...
Cohesion: 0.17
Nodes (12): scripts, build, db:generate, db:init, db:migrate-journal, db:migrate:local, db:migrate:prod, db:seed:local (+4 more)
...
Cohesion: 0.15
Nodes (8): DashboardView(), NetWorthView(), NetWorthViewProps, SettlementView(), SettlementViewProps, formatCurrency(), TransactionFormView(), TransactionFormViewProps

### Community 14 - "Monthly Flow UI Components"
Cohesion: 0.21
Nodes (8): EMPTY_ACCOUNTS, EMPTY_TRANSACTIONS, MONTHS, CategoryPostingRow, MonthlyFlowCategoryView(), MonthlyFlowCategoryViewProps, MonthlyFlowView(), MonthlyFlowViewProps
...
Cohesion: 0.07
Nodes (23): AccountsController, createAccountSchema, updateAccountSchema, accountsRouter, AccountEntitySchema, AccountType, AccountTypeSchema, AccountIdSchema (+15 more)
...
## Knowledge Gaps
- **165 isolated node(s):** `envSchema`, `parsed`, `DbClient`, `DBPosting`, `preferences` (+160 more)
...
- **Why does `cn()` connect `Entity Management UI` to `Dashboard UI Components`, `Monthly Flow UI Components`, `Ledger View Components`, `Select Input Component`, `Button UI Component`?**
